...
**Pulsegram** — платформа для управления Telegram-аккаунтами и автоматизации взаимодействия с контентом.  
Проект позволяет моделировать поведение реального пользователя и автоматически генерировать осмысленные комментарии к постам с использованием нейросетей, анализируя содержание публикаций.
<br>
[Pulsegram](https://pulsegram.ru/)
